...
exports.publishMessageParamsSchema = zod_1.z.object({
    name: zod_1.z.string(),
...
exports.unpublishMessageParamsSchema = zod_1.z.object({
    pubuid: zod_1.z.number(),
});
/** Schema for the set properties message params in the NT protocol. */
exports.setPropertiesMessageParamsSchema = zod_1.z.object({
    name: zod_1.z.string(),
    update: exports.topicPropertiesSchema,
});
/** Schema for the subscribe message params in the NT protocol. */
exports.subscribeMessageParamsSchema = zod_1.z.object({
...
exports.unsubscribeMessageParamsSchema = zod_1.z.object({
    subuid: zod_1.z.number(),
});
/** Schema for the announce message params in the NT protocol. */
exports.announceMessageParamsSchema = exports.topicSchema.extend({
    pubuid: zod_1.z.number().optional(),
});
/** Schema for the unannounce message params in the NT protocol. */
exports.unannounceMessageParamsSchema = zod_1.z.object({
    name: zod_1.z.string(),
    id: zod_1.z.number(),
});
/** Schema for the properties message params in the NT protocol. */
exports.propertiesMessageParamsSchema = zod_1.z.object({
    name: zod_1.z.string(),
    ack: zod_1.z.boolean(),
});
/** Schema for a publish message in the NT protocol. */
exports.publishMessageSchema = zod_1.z.object({
...
exports.unpublishMessageSchema = zod_1.z.object({
...
exports.setPropertiesMessageSchema = zod_1.z.object({
...
exports.subscribeMessageSchema = zod_1.z.object({
...
exports.announceMessageSchema = zod_1.z.object({
...
exports.unannounceMessageSchema = zod_1.z.object({
...
exports.propertiesMessageSchema = zod_1.z.object({
