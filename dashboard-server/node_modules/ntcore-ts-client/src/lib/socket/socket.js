...
var NetworkTablesSocket = /** @class */ (function () {
     ...
     */
    function NetworkTablesSocket(serverUrl, onSocketOpen, onSocketClose, onTopicUpdate, onAnnounce, onUnannounce, onProperties, autoConnect) {
        ...
        this._websocket = new isomorphic_ws_1.default(serverUrl, [NetworkTablesSocket.PROTOCOL_V4_1, NetworkTablesSocket.PROTOCOL_V4_0]);
     ...
     */
    NetworkTablesSocket.getInstance = function (serverUrl, onSocketOpen, onSocketClose, onTopicUpdate, onAnnounce, onUnannounce, onProperties, autoConnect) {
        if (autoConnect === void 0) { autoConnect = true; }
        var instance = this.instances.get(serverUrl);
        if (!instance) {
            instance = new this(serverUrl, onSocketOpen, onSocketClose, onTopicUpdate, onAnnounce, onUnannounce, onProperties, autoConnect);
    ...
    NetworkTablesSocket.prototype.init = function () {
        ...
        if (this._websocket) {
            ...
            this._websocket.onopen = function () {
                ...
                if (_this._websocket.protocol === 'v4.1.networktables.first.wpi.edu') {
            ...
            this._websocket.onclose = function (e) {
                ...
                if (_this.autoConnect) {
                    console.warn("Reconnect will be attempted in ".concat(NetworkTablesSocket.RECONNECT_TIMEOUT, " milliseconds."));
                    setTimeout(function () {
                        _this._websocket = new isomorphic_ws_1.default(_this.serverUrl, [
