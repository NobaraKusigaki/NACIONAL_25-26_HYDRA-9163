...
var prefix_topic_1 = require("./pubsub/prefix-topic");
...
var NetworkTables = /** @class */ (function () {
     ...
     * @returns The topic.
     */
    NetworkTables.prototype.createPrefixTopic = function (prefix) {
        return new prefix_topic_1.NetworkTablesPrefixTopic(this._client, prefix);
    };
